...
public class CSCAN_DISK_SH {
    public static void main(String[] args) {
        ...
        switch (choice){
            case 1 : small(arr, rwhead, ntrack);
                break;
    ...
    public static void small(int[] arr , int rwhead, int ntrack){
        Scanner sc = new Scanner(System.in);
        Arrays.sort(arr);
        ...
        st = st * t;
        tst = tst + st;
        System.out.println("|  "+arr[0]+" ---> "+(ntrack-1)+"     :       "+st+"         ");

        st = (ntrack-1) - arr[arr.length-1];
        st = st * t;
        tst = tst + st;
        System.out.println("|  "+(ntrack-1)+" ---> "+arr[arr.length-1]+"     :       "+st+"         ");
    ...
    public static void large(int[] arr , int rwhead){
        ...
        st = st * t;
        tst = tst + st;
        System.out.println("|  "+arr[arr.length-1]+" ---> "+0+"     :       "+st+"         ");

        st = arr[0];
        st = st * t;
        tst = tst + st;
        System.out.println("|  "+0+" ---> "+arr[0]+"     :       "+st+"         ");
